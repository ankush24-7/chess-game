const startBoard = game => {
    ...
    const resetBoard = () => {
        ...
        for (const piece of game.pieces) {
            ...
            square.innerHTML = `<img class="piece ${piece.rank}" id="${piece.name}" src="img/${piece.color}-${piece.rank}.svg">`
        }
    }
    ...
    game.on('promotion', queen => {
        ...
        square.innerHTML = `<img class="piece queen" id="${queen.name}" src="img/${queen.color}Queen.svg">`;
    })
